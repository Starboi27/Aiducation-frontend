  ...
  return (
    <div className="ranking-table">
      <div className="ranking-table__header">
        <span className="ranking-table__col ranking-table__col--rank">순위</span>
        <span className="ranking-table__col ranking-table__col--user">유저</span>
        <span className="ranking-table__col ranking-table__col--level">등급</span>
        <span className="ranking-table__col ranking-table__col--xp">XP</span>
        <span className="ranking-table__col ranking-table__col--streak">스트릭</span>
        <span className="ranking-table__col ranking-table__col--accuracy">정확도</span>
      </div>
          ...
          return (
            ...
            >
              <div className="ranking-table__col ranking-table__col--rank">
                {medal ? (
                  <div className="ranking-table__medal" style={{ color: medal.color }}>
              ...
              <div className="ranking-table__col ranking-table__col--xp">
                <div className="ranking-table__xp-wrap">
                  ...
                  <span className="ranking-table__xp-val">{user.totalExp.toLocaleString()}</span>
                </div>
                <ProgressBar
              ...
              <div className="ranking-table__col ranking-table__col--accuracy">
                <span className="ranking-table__accuracy"
                  style={{ color: user.accuracy >= 80 ? 'var(--color-success)' : user.accuracy >= 60 ? 'var(--color-gold)' : '#ff7675' }}>
                  {user.accuracy}%
                </span>
              </div>
            </div>
